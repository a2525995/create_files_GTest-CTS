...
def changexlmd(file1,sheet1_name):
    ...
    for i in range(2,sheet.max_row):
        for m in range(1,sheet.max_column):
            sheet1.cell(row=i,column=m).value


    wb.save("dfjhgjdfh.xlsx")
...
if __name__ == '__main__':
    changexlmd("/home/CORPUSERS/xp023799/Downloads/OCA+proyotypes.xlsx","Prototype2","/home/CORPUSERS/xp023799/Downloads/OCA+proyotypes.xlsx","OCA Prototypes")
